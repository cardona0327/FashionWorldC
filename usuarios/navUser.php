  ...
  <a class="navbar-brand" href="conBaBus.php?seccion=home"><h1><b>FASHION WORLD</b></h1></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"><a class="nav-link active" aria-current="page" href="conBaBus.php?seccion=todo">categorias</a></li>
        <li class="nav-item"><a class="nav-link active" aria-current="page" href="conBaBus.php?seccion=verTodoProUser">Todos los productos</a></li>
